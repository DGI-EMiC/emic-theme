 ...
 *   entirety and paste it here, changing the prefix from theme_ to emic_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: emic_breadcrumb()
 *
 ...
 */
function emic_theme(&$existing, $type, $theme, $path) {
...
function emic_preprocess(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function emic_preprocess_node(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
 ...
 */
/* -- Delete this line if you want to use this function
function emic_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function emic_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
